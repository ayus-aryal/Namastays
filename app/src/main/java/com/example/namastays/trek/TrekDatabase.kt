...
@Database(
    entities = [
        CustomMarker::class,
        DownloadedTrek::class,
        TrekNavigationSession::class,
        TrekCacheEntity::class,
        TrekItineraryDayEntity::class,    // new
        TrekHighlightEntity::class        // new
    ],
...
abstract class TrekDatabase : RoomDatabase() {
    ...
    abstract fun trekItineraryDao():     TrekItineraryDao   // new
    abstract fun trekHighlightDao():     TrekHighlightDao   // new

    companion object {
        @Volatile private var INSTANCE: TrekDatabase? = null
